...
export const PricingSection = ({ scrollTo, onSelectPlan }: PricingSectionProps) => (
  <section id="prezzi" className="py-24 md:py-32 bg-[#E6DFF5]/50 border-y border-[#E6DFF5]">
    <div className="max-w-5xl mx-auto px-6 md:px-12">
      <div className="max-w-2xl mx-auto text-center">
        <span className="text-xs font-bold uppercase tracking-[0.2em] text-[#36255C]">Prezzi</span>
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-[#36255C] mt-3 font-heading">
          Semplice per tutti
        </h2>
        <p className="text-[#6B6575] mt-4 text-sm md:text-base leading-relaxed">
        ...
        <div className="mt-6 inline-flex items-center gap-2 rounded-full bg-white border border-[#E6DFF5] px-4 py-2 text-[#6B6575] text-xs font-semibold">
          <Gift className="w-4 h-4 text-[#36255C]" />
      ...
      >
        <div className="grid grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)_minmax(0,1fr)_minmax(0,1fr)] gap-0 text-sm border-b border-[#E6DFF5] bg-[#EDE6FA] font-bold uppercase tracking-wider text-[10px] text-[#948E9C]">
        ...
        {ROWS.map((row, i) => (
          <motion.div
            ...
            className={`grid grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)_minmax(0,1fr)_minmax(0,1fr)] gap-0 border-b border-[#E6DFF5] last:border-b-0 ${
              row.highlight ? "bg-[#ECFDF5]/60" : "bg-white"
            }`}
          >
            <div className="p-4 md:p-5 flex items-center gap-2">
              <span className="font-extrabold text-[#36255C] text-base font-heading">{row.tier}</span>
              {row.highlight && (
                <span className="text-[9px] font-black bg-[#36255C] text-white px-2 py-0.5 rounded-full uppercase">
                  Top
                </span>
              )}
            </div>
            <div className="p-4 md:p-5 font-extrabold text-[#36255C] text-base font-heading flex items-center">
              {row.price}
            </div>
            <div className="p-4 md:p-5 text-[#6B6575] font-medium leading-snug flex items-center">
              {row.restaurant}
            </div>
            <div className="p-4 md:p-5 text-[#6B6575] font-medium leading-snug flex items-center">
              {row.customer}
      ...
      >
        ...
        <div className="flex-1">
          <h3 className="text-lg font-extrabold text-[#36255C] font-heading">Boost · €9,90 una tantum</h3>
          <p className="text-sm text-[#6B6575] mt-1">
