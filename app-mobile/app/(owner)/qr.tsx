  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.card}>
        ...
        <Image
          style={styles.qr}
          source={{ uri: `https://api.qrserver.com/v1/create-qr-code/?size=440x440&data=allertgy:${current.public_code}` }}
        />
        <Text style={styles.hint}>
          I clienti scansionano questo QR (o digitano il codice) nell'app AllerTgy
          e vedono il tuo menù filtrato sulle LORO allergie.
        </Text>
      </View>
